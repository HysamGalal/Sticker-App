// Panini FIFA World Cup 2026 sticker album — 980 stickers
// Each team has 20 stickers: team logo (1), 11 players (2-12), team photo (13), 7 players (14-20).
...
const TEAM_META = {
    ...
    "Australia": { flag: "🇦🇺", colors: ["#00843d", "#ffd100"] },
    "Austria": { flag: "🇦🇹", colors: ["#ed2939", "#ffffff", "#ed2939"] },
    "Belgium": { flag: "🇧🇪", colors: ["#000000", "#fae042", "#ed2939"] },
    "Bosnia-Herzegovina": { flag: "🇧🇦", colors: ["#002395", "#fecb00"] },
    "Brazil": { flag: "🇧🇷", colors: ["#009c3b", "#ffdf00"] },
    "Canada": { flag: "🇨🇦", colors: ["#d52b1e", "#ffffff", "#d52b1e"] },
    "Cabo Verde": { flag: "🇨🇻", colors: ["#003893", "#cf2027"] },
    "Colombia": { flag: "🇨🇴", colors: ["#fcd116", "#003893", "#ce1126"] },
    "Congo DR": { flag: "🇨🇩", colors: ["#007fff", "#f7d518", "#ce1021"] },
    "Croatia": { flag: "🇭🇷", colors: ["#ff0000", "#ffffff", "#171796"] },
    "Curaçao": { flag: "🇨🇼", colors: ["#002b7f", "#f9e814"] },
    "Czechia": { flag: "🇨🇿", colors: ["#11457e", "#ffffff", "#d7141a"] },
    "Ecuador": { flag: "🇪🇨", colors: ["#ffdd00", "#034ea2", "#ed1c24"] },
    "Egypt": { flag: "🇪🇬", colors: ["#ce1126", "#ffffff", "#000000"] },
    "England": { flag: "🏴󠁧󠁢󠁥󠁮󠁧󠁿", colors: ["#ce1124", "#ffffff"] },
    "France": { flag: "🇫🇷", colors: ["#002654", "#ffffff", "#ed2939"] },
    "Germany": { flag: "🇩🇪", colors: ["#000000", "#dd0000", "#ffce00"] },
    "Ghana": { flag: "🇬🇭", colors: ["#ce1126", "#fcd116", "#006b3f"] },
    "Haiti": { flag: "🇭🇹", colors: ["#00209f", "#d21034"] },
    "IR Iran": { flag: "🇮🇷", colors: ["#239f40", "#ffffff", "#da0000"] },
    "Iraq": { flag: "🇮🇶", colors: ["#ce1126", "#ffffff", "#000000"] },
    "Côte d'Ivoire": { flag: "🇨🇮", colors: ["#ff8200", "#ffffff", "#009e60"] },
    "Japan": { flag: "🇯🇵", colors: ["#ffffff", "#bc002d"] },
    "Jordan": { flag: "🇯🇴", colors: ["#000000", "#ffffff", "#007a3d"] },
    "Mexico": { flag: "🇲🇽", colors: ["#006847", "#ffffff", "#ce1126"] },
    "Morocco": { flag: "🇲🇦", colors: ["#c1272d", "#006233"] },
    "Netherlands": { flag: "🇳🇱", colors: ["#ff6600", "#c8102e"] },
    "New Zealand": { flag: "🇳🇿", colors: ["#000000", "#ffffff"] },
    "Norway": { flag: "🇳🇴", colors: ["#ef2b2d", "#ffffff", "#002868"] },
    "Panama": { flag: "🇵🇦", colors: ["#005293", "#ffffff", "#d21034"] },
    "Paraguay": { flag: "🇵🇾", colors: ["#d52b1e", "#ffffff", "#0038a8"] },
    "Portugal": { flag: "🇵🇹", colors: ["#006600", "#ff0000"] },
    "Qatar": { flag: "🇶🇦", colors: ["#8a1538", "#ffffff"] },
    "Saudi Arabia": { flag: "🇸🇦", colors: ["#006c35", "#ffffff"] },
    "Scotland": { flag: "🏴󠁧󠁢󠁳󠁣󠁴󠁿", colors: ["#005eb8", "#ffffff"] },
    "Senegal": { flag: "🇸🇳", colors: ["#00853f", "#fdef42", "#e31b23"] },
    "South Africa": { flag: "🇿🇦", colors: ["#007a4d", "#ffb612", "#000000"] },
    "Korea Republic": { flag: "🇰🇷", colors: ["#cd2e3a", "#0047a0"] },
    "Spain": { flag: "🇪🇸", colors: ["#aa151b", "#f1bf00"] },
    "Sweden": { flag: "🇸🇪", colors: ["#006aa7", "#fecc00"] },
    "Switzerland": { flag: "🇨🇭", colors: ["#d52b1e", "#ffffff"] },
    "Tunisia": { flag: "🇹🇳", colors: ["#e70013", "#ffffff"] },
    "Türkiye": { flag: "🇹🇷", colors: ["#e30a17", "#ffffff"] },
    "Uruguay": { flag: "🇺🇾", colors: ["#7b9ace", "#ffffff", "#fcd116"] },
    "USA": { flag: "🇺🇸", colors: ["#bf0a30", "#ffffff", "#002868"] },
    "Uzbekistan": { flag: "🇺🇿", colors: ["#0099b5", "#ffffff", "#1eb53a"] },
    "Coca-Cola Insert Set": { flag: "🥤", colors: ["#e61a27", "#1a1a1a"] },
};
...
const STICKER_DATA = [
    ...
    },
    {
        ...
        stickers: [
            ...
            ["FWC11", "Italy 1938"],
            ["FWC12", "Uruguay 1950"],
            ["FWC13", "West Germany 1954"],
            ["FWC14", "Brazil 1958"],
            ["FWC15", "Brazil 1962"],
            ["FWC16", "England 1966"],
            ["FWC17", "Brazil 1970"],
            ["FWC18", "West Germany 1974"],
            ["FWC19", "Argentina 1978"],
            ["FWC20", "Italy 1982"],
            ["FWC21", "Argentina 1986"],
            ["FWC22", "West Germany 1990"],
            ["FWC23", "Brazil 1994"],
            ["FWC24", "France 1998"],
            ["FWC25", "Brazil 2002"],
            ["FWC26", "Italy 2006"],
            ...
            ["FWC28", "Germany 2014"],
            ["FWC29", "France 2018"],
            ["FWC30", "Argentina 2022"],
        ],
    },
    {
        team: "Algeria",
        stickers: [
            ["ALG1", "Team Logo"], ["ALG2", "Alexis Guendouz"], ["ALG3", "Ramy Bensebaini"],
            ["ALG4", "Youcef Atal"], ["ALG5", "Rayan Aït-Nouri"], ["ALG6", "Mohamed Amine Tougai"],
            ["ALG7", "Aïssa Mandi"], ["ALG8", "Ismaël Bennacer"], ["ALG9", "Houssem Aouar"],
            ["ALG10", "Hicham Boudaoui"], ["ALG11", "Ramiz Zerrouki"], ["ALG12", "Nabil Bentaleb"],
            ["ALG13", "Team Photo"], ["ALG14", "Farès Chaïbi"], ["ALG15", "Riyad Mahrez"],
            ["ALG16", "Saïd Benrahma"], ["ALG17", "Anis Hadj Moussa"], ["ALG18", "Amine Gouiri"],
    ...
    },
    {
        team: "Argentina",
        stickers: [
            ["ARG1", "Team Logo"], ["ARG2", "Emiliano Martínez"], ["ARG3", "Nahuel Molina"],
            ["ARG4", "Cristian Romero"], ["ARG5", "Nicolás Otamendi"], ["ARG6", "Nicolás Tagliafico"],
            ["ARG7", "Leonardo Balerdi"], ["ARG8", "Enzo Fernández"], ["ARG9", "Alexis Mac Allister"],
            ...
            ["ARG16", "Nico González"], ["ARG17", "Lionel Messi"], ["ARG18", "Lautaro Martínez"],
    ...
    },
    {
        team: "Australia",
        stickers: [
            ["AUS1", "Team Logo"], ["AUS2", "Mathew Ryan"], ["AUS3", "Joe Gauci"],
            ...
            ["AUS16", "Patrick Yazbek"], ["AUS17", "Craig Goodwin"], ["AUS18", "Kusini Yengi"],
    ...
    },
    {
        team: "Austria",
        stickers: [
            ["AUT1", "Team Logo"], ["AUT2", "Alexander Schlager"], ["AUT3", "Patrick Pentz"],
            ["AUT4", "David Alaba"], ["AUT5", "Kevin Danso"], ["AUT6", "Philipp Lienhart"],
            ["AUT7", "Stefan Posch"], ["AUT8", "Philipp Mwene"], ["AUT9", "Alexander Prass"],
    ...
    },
    {
        team: "Belgium",
        stickers: [
            ["BEL1", "Team Logo"], ["BEL2", "Thibaut Courtois"], ["BEL3", "Arthur Theate"],
    ...
    },
    {
        ...
        stickers: [
            ["BIH1", "Team Logo"], ["BIH2", "Nikola Vasilj"], ["BIH3", "Amar Dedić"],
            ["BIH4", "Sead Kolašinac"], ["BIH5", "Tarik Muharemović"], ["BIH6", "Nihad Mujakić"],
            ["BIH7", "Nikola Katić"], ["BIH8", "Amir Hadžiahmetović"], ["BIH9", "Benjamin Tahirović"],
            ["BIH10", "Armin Gigović"], ["BIH11", "Ivan Šunjić"], ["BIH12", "Ivan Bašić"],
            ["BIH13", "Team Photo"], ["BIH14", "Dženis Burnić"], ["BIH15", "Esmir Bajraktarević"],
            ["BIH16", "Amar Memić"], ["BIH17", "Ermedin Demirović"], ["BIH18", "Edin Džeko"],
            ["BIH19", "Samed Baždar"], ["BIH20", "Haris Tabaković"],
        ],
    },
    {
        team: "Brazil",
        stickers: [
            ["BRA1", "Team Logo"], ["BRA2", "Alisson"], ["BRA3", "Bento"],
            ...
            ["BRA19", "Raphinha"], ["BRA20", "Estêvão"],
        ],
    },
    {
        team: "Canada",
        stickers: [
            ["CAN1", "Team Logo"], ["CAN2", "Dayne St.Clair"], ["CAN3", "Alphonso Davies"],
            ["CAN4", "Alistair Johnston"], ["CAN5", "Samuel Adekugbe"], ["CAN6", "Richie Laryea"],
    ...
    },
    {
        team: "Cabo Verde",
        stickers: [
            ["CPV1", "Team Logo"], ["CPV2", "Vozinha"], ["CPV3", "Logan Costa"],
            ["CPV4", "Pico"], ["CPV5", "Diney"], ["CPV6", "Steven Moreira"],
            ["CPV7", "Wagner Pina"], ["CPV8", "João Paulo"], ["CPV9", "Yannick Semedo"],
            ...
            ["CPV19", "Willy Semedo"], ["CPV20", "Bebé"],
        ],
    },
    {
        team: "Colombia",
        stickers: [
            ["COL1", "Team Logo"], ["COL2", "Camilo Vargas"], ["COL3", "David Ospina"],
            ["COL4", "Dávinson Sánchez"], ["COL5", "Yerry Mina"], ["COL6", "Daniel Muñoz"],
            ["COL7", "Johan Mojica"], ["COL8", "Jhon Lucumí"], ["COL9", "Santiago Arias"],
            ["COL10", "Jefferson Lerma"], ["COL11", "Kevin Castaño"], ["COL12", "Richard Ríos"],
            ["COL13", "Team Photo"], ["COL14", "James Rodríguez"], ["COL15", "Juan Fernando Quintero"],
            ["COL16", "Jorge Carrascal"], ["COL17", "Jhon Arias"], ["COL18", "Jhon Córdoba"],
            ["COL19", "Luis Suárez"], ["COL20", "Luis Díaz"],
        ],
    },
    {
        team: "Congo DR",
        stickers: [
            ["COD1", "Team Logo"], ["COD2", "Lionel Mpasi"], ["COD3", "Aaron Wan-Bissaka"],
    ...
    },
    {
        team: "Croatia",
        stickers: [
            ["CRO1", "Team Logo"], ["CRO2", "Dominik Livaković"], ["CRO3", "Duje Ćaleta-Car"],
            ["CRO4", "Joško Gvardiol"], ["CRO5", "Josip Stanišić"], ["CRO6", "Luka Vušković"],
            ["CRO7", "Josip Sutalo"], ["CRO8", "Kristijan Jakić"], ["CRO9", "Luka Modrić"],
            ["CRO10", "Mateo Kovačić"], ["CRO11", "Martin Baturina"], ["CRO12", "Lovro Majer"],
            ["CRO13", "Team Photo"], ["CRO14", "Mario Pašalić"], ["CRO15", "Petar Sučić"],
            ["CRO16", "Ivan Perišić"], ["CRO17", "Marco Pašalić"], ["CRO18", "Ante Budimir"],
            ["CRO19", "Andrej Kramarić"], ["CRO20", "Franjo Ivanović"],
        ],
    },
    {
        team: "Curaçao",
        stickers: [
            ["CUW1", "Team Logo"], ["CUW2", "Eloy Room"], ["CUW3", "Armando Obispo"],
            ["CUW4", "Sherel Floranus"], ["CUW5", "Juriën Gaari"], ["CUW6", "Joshua Brenet"],
            ...
            ["CUW13", "Team Photo"], ["CUW14", "Tahith Chong"], ["CUW15", "Kenji Gorré"],
            ["CUW16", "Jearl Margaritha"], ["CUW17", "Jürgen Locadia"], ["CUW18", "Jeremy Antonisse"],
    ...
    },
    {
        team: "Czechia",
        stickers: [
            ["CZE1", "Team Logo"], ["CZE2", "Matej Kovar"], ["CZE3", "Jindrich Stanek"],
    ...
    },
    {
        team: "Ecuador",
        stickers: [
            ["ECU1", "Team Logo"], ["ECU2", "Hernán Galíndez"], ["ECU3", "Gonzalo Valle"],
            ["ECU4", "Piero Hincapié"], ["ECU5", "Pervis Estupiñán"], ["ECU6", "Willian Pacho"],
            ["ECU7", "Ángelo Preciado"], ["ECU8", "Joel Ordóñez"], ["ECU9", "Moisés Caicedo"],
            ["ECU10", "Alan Franco"], ["ECU11", "Kendry Páez"], ["ECU12", "Pedro Vite"],
            ["ECU13", "Team Photo"], ["ECU14", "John Yeboah"], ["ECU15", "Leonardo Campaña"],
            ["ECU16", "Gonzalo Plata"], ["ECU17", "Nilson Angulo"], ["ECU18", "Alan Minda"],
            ["ECU19", "Kevin Rodríguez"], ["ECU20", "Enner Valencia"],
        ],
    },
    {
        team: "Egypt",
        stickers: [
            ["EGY1", "Team Logo"], ["EGY2", "Mohamed Elshenawy"], ["EGY3", "Mohamed Hany"],
            ...
            ["EGY13", "Team Photo"], ["EGY14", "Mohanad Lasheen"], ["EGY15", "Emam Ashour"],
    ...
    },
    {
        team: "England",
        stickers: [
            ["ENG1", "Team Logo"], ["ENG2", "Jordan Pickford"], ["ENG3", "John Stones"],
    ...
    },
    {
        team: "France",
        stickers: [
            ["FRA1", "Team Logo"], ["FRA2", "Mike Maignan"], ["FRA3", "Théo Hernandez"],
            ["FRA4", "William Saliba"], ["FRA5", "Jules Koundé"], ["FRA6", "Ibrahima Konaté"],
            ["FRA7", "Dayot Upamecano"], ["FRA8", "Lucas Digne"], ["FRA9", "Aurélien Tchouaméni"],
            ["FRA10", "Eduardo Camavinga"], ["FRA11", "Manu Koné"], ["FRA12", "Adrien Rabiot"],
            ["FRA13", "Team Photo"], ["FRA14", "Michael Olise"], ["FRA15", "Ousmane Dembélé"],
            ["FRA16", "Bradley Barcola"], ["FRA17", "Désiré Doué"], ["FRA18", "Kingsley Coman"],
            ["FRA19", "Hugo Ekitiké"], ["FRA20", "Kylian Mbappé"],
        ],
    },
    {
        team: "Germany",
        stickers: [
            ["GER1", "Team Logo"], ["GER2", "Marc-André ter Stegen"], ["GER3", "Jonathan Tah"],
            ["GER4", "David Raum"], ["GER5", "Nico Schlotterbeck"], ["GER6", "Antonio Rüdiger"],
            ["GER7", "Waldemar Anton"], ["GER8", "Ridle Baku"], ["GER9", "Maximilian Mittelstädt"],
            ["GER10", "Joshua Kimmich"], ["GER11", "Florian Wirtz"], ["GER12", "Felix Nmecha"],
            ["GER13", "Team Photo"], ["GER14", "Leon Goretzka"], ["GER15", "Jamal Musiala"],
            ["GER16", "Serge Gnabry"], ["GER17", "Kai Havertz"], ["GER18", "Leroy Sané"],
    ...
    },
    {
        team: "Ghana",
        stickers: [
            ["GHA1", "Team Logo"], ["GHA2", "Lawrence Ati Zigi"], ["GHA3", "Tariq Lamptey"],
            ...
            ["GHA13", "Team Photo"], ["GHA14", "Mohammed Kudus"], ["GHA15", "Iñaki Williams"],
            ["GHA16", "Jordan Ayew"], ["GHA17", "André Ayew"], ["GHA18", "Joseph Paintsil"],
    ...
    },
    {
        team: "Haiti",
        stickers: [
            ["HAI1", "Team Logo"], ["HAI2", "Johny Placide"], ["HAI3", "Carlens Arcus"],
    ...
    },
    {
        team: "IR Iran",
        stickers: [
            ["IRN1", "Team Logo"], ["IRN2", "Alireza Beiranvand"], ["IRN3", "Morteza Pouraliganji"],
    ...
    },
    {
        team: "Iraq",
        stickers: [
            ["IRQ1", "Team Logo"], ["IRQ2", "Jalal Hassan"], ["IRQ3", "Rebin Sulaka"],
            ["IRQ4", "Hussein Ali"], ["IRQ5", "Akam Hashem"], ["IRQ6", "Merchas Doski"],
            ["IRQ7", "Zaid Tahseen"], ["IRQ8", "Manaf Younis"], ["IRQ9", "Zidane Iqbal"],
            ["IRQ10", "Amir Al-Ammari"], ["IRQ11", "Ibrahim Bayesh"], ["IRQ12", "Ali Jasim"],
    ...
    },
    {
        ...
        stickers: [
            ...
            ["CIV19", "Evann Guessand"], ["CIV20", "Oumar Diakité"],
        ],
    },
    {
        team: "Japan",
        stickers: [
            ["JPN1", "Team Logo"], ["JPN2", "Zion Suzuki"], ["JPN3", "Henry Heroki Mochizuki"],
    ...
    },
    {
        team: "Jordan",
        stickers: [
            ["JOR1", "Team Logo"], ["JOR2", "Yazeed Abulaila"], ["JOR3", "Ihsan Haddad"],
            ...
            ["JOR13", "Team Photo"], ["JOR14", "Amer Jamous"], ["JOR15", "Mousa Al-Taamari"],
    ...
    },
    {
        team: "Mexico",
        stickers: [
            ["MEX1", "Team Logo"], ["MEX2", "Luis Malagón"], ["MEX3", "Johan Vasquez"],
    ...
    },
    {
        team: "Morocco",
        stickers: [
            ["MAR1", "Team Logo"], ["MAR2", "Yassine Bounou"], ["MAR3", "Munir El Kajoui"],
            ["MAR4", "Achraf Hakimi"], ["MAR5", "Noussair Mazraoui"], ["MAR6", "Nayef Aguerd"],
            ["MAR7", "Romain Saïss"], ["MAR8", "Jawad El Yamiq"], ["MAR9", "Adam Masina"],
    ...
    },
    {
        team: "Netherlands",
        stickers: [
            ["NED1", "Team Logo"], ["NED2", "Bart Verbruggen"], ["NED3", "Virgil van Dijk"],
            ["NED4", "Micky van de Ven"], ["NED5", "Jurriën Timber"], ["NED6", "Denzel Dumfries"],
    ...
    },
    {
        team: "New Zealand",
        stickers: [
            ["NZL1", "Team Logo"], ["NZL2", "Max Crocombe"], ["NZL3", "Alex Paulsen"],
    ...
    },
    {
        team: "Norway",
        stickers: [
            ["NOR1", "Team Logo"], ["NOR2", "Ørjan Nyland"], ["NOR3", "Julian Ryerson"],
            ["NOR4", "Leo Østigård"], ["NOR5", "Kristoffer Vassbakk Ajer"], ["NOR6", "Marcus Holmgren Pedersen"],
            ...
            ["NOR16", "Alexander Sørloth"], ["NOR17", "Aron Dønnum"], ["NOR18", "Jørgen Strand Larsen"],
    ...
    },
    {
        team: "Panama",
        stickers: [
            ["PAN1", "Team Logo"], ["PAN2", "Orlando Mosquera"], ["PAN3", "Luis Mejía"],
            ["PAN4", "Fidel Escobar"], ["PAN5", "Andrés Andrade"], ["PAN6", "Michael Amir Murillo"],
            ["PAN7", "Eric Davis"], ["PAN8", "José Córdoba"], ["PAN9", "César Blackman"],
            ["PAN10", "Cristian Martínez"], ["PAN11", "Aníbal Godoy"], ["PAN12", "Adalberto Carrasquilla"],
            ["PAN13", "Team Photo"], ["PAN14", "Édgar Bárcenas"], ["PAN15", "Carlos Harvey"],
            ["PAN16", "Ismael Díaz"], ["PAN17", "José Fajardo"], ["PAN18", "Cecilio Waterman"],
            ["PAN19", "José Luis Rodríguez"], ["PAN20", "Alberto Quintero"],
        ],
    },
    {
        team: "Paraguay",
        stickers: [
            ["PAR1", "Team Logo"], ["PAR2", "Roberto Fernández"], ["PAR3", "Orlando Gill"],
            ["PAR4", "Gustavo Gómez"], ["PAR5", "Fabián Balbuena"], ["PAR6", "Juan José Cáceres"],
            ["PAR7", "Omar Alderete"], ["PAR8", "Junior Alonso"], ["PAR9", "Mathías Villasanti"],
            ["PAR10", "Diego Gómez"], ["PAR11", "Damián Bobadilla"], ["PAR12", "Andrés Cubas"],
            ["PAR13", "Team Photo"], ["PAR14", "Matías Galarza Fonda"], ["PAR15", "Julio Enciso"],
            ["PAR16", "Alejandro Romero Gamarra"], ["PAR17", "Miguel Almirón"], ["PAR18", "Ramón Sosa"],
    ...
    },
    {
        team: "Portugal",
        stickers: [
            ["POR1", "Team Logo"], ["POR2", "Diogo Costa"], ["POR3", "José Sá"],
            ["POR4", "Rúben Dias"], ["POR5", "João Cancelo"], ["POR6", "Diogo Dalot"],
            ["POR7", "Nuno Mendes"], ["POR8", "Gonçalo Inácio"], ["POR9", "Bernardo Silva"],
            ["POR10", "Bruno Fernandes"], ["POR11", "Rúben Neves"], ["POR12", "Vitinha"],
            ["POR13", "Team Photo"], ["POR14", "João Neves"], ["POR15", "Cristiano Ronaldo"],
            ["POR16", "Francisco Trincão"], ["POR17", "João Félix"], ["POR18", "Gonçalo Ramos"],
    ...
    },
    {
        team: "Qatar",
        stickers: [
            ["QAT1", "Team Logo"], ["QAT2", "Meshaal Barsham"], ["QAT3", "Sultan Albrake"],
            ["QAT4", "Lucas Mendes"], ["QAT5", "Homam Ahmed"], ["QAT6", "Boualem Khoukhi"],
            ["QAT7", "Pedro Miguel"], ["QAT8", "Tarek Salman"], ["QAT9", "Mohammed Mannai"],
            ["QAT10", "Karim Boudiaf"], ["QAT11", "Assim Madibo"], ["QAT12", "Hamed Fatehi"],
            ["QAT13", "Team Photo"], ["QAT14", "Mohammed Waad"], ["QAT15", "Abdulaziz Hatem"],
            ["QAT16", "Hassan Al-Haydos"], ["QAT17", "Edmílson Junior"], ["QAT18", "Akram Hassan Afif"],
    ...
    },
    {
        team: "Saudi Arabia",
        stickers: [
            ["KSA1", "Team Logo"], ["KSA2", "Nawaf Alaqidi"], ["KSA3", "Abdulrahman Alsanbi"],
            ["KSA4", "Saud Abdulhamid"], ["KSA5", "Nawaf Buwashl"], ["KSA6", "Jehad Thikri"],
            ["KSA7", "Moteb Alharbi"], ["KSA8", "Hassan Altambakti"], ["KSA9", "Musab Aljuwayr"],
            ...
            ["KSA16", "Salem Aldawsari"], ["KSA17", "Abdulrahman Alobud"], ["KSA18", "Feras Albrikan"],
            ["KSA19", "Saleh Alshehri"], ["KSA20", "Abdullah Alhamdan"],
        ],
    },
    {
        team: "Scotland",
        stickers: [
            ["SCO1", "Team Logo"], ["SCO2", "Angus Gunn"], ["SCO3", "Jack Hendry"],
    ...
    },
    {
        team: "Senegal",
        stickers: [
            ["SEN1", "Team Logo"], ["SEN2", "Edouard Mendy"], ["SEN3", "Yehvann Diouf"],
            ...
            ["SEN13", "Team Photo"], ["SEN14", "Lamine Camara"], ["SEN15", "Sadio Mané"],
    ...
    },
    {
        team: "South Africa",
        stickers: [
            ["RSA1", "Team Logo"], ["RSA2", "Ronwen Williams"], ["RSA3", "Sipho Chaine"],
    ...
    },
    {
        team: "Korea Republic",
        stickers: [
            ["KOR1", "Team Logo"], ["KOR2", "Hyeon-woo Jo"], ["KOR3", "Seung-Gyu Kim"],
            ...
            ["KOR16", "Dong-gyeong Lee"], ["KOR17", "Gue-sung Cho"], ["KOR18", "Heung-min Son"],
    ...
    },
    {
        team: "Sweden",
        stickers: [
            ["SWE1", "Team Logo"], ["SWE2", "Victor Johansson"], ["SWE3", "Isak Hien"],
    ...
    },
    {
        team: "Switzerland",
        stickers: [
            ["SUI1", "Team Logo"], ["SUI2", "Gregor Kobel"], ["SUI3", "Yvon Mvogo"],
            ["SUI4", "Manuel Akanji"], ["SUI5", "Ricardo Rodríguez"], ["SUI6", "Nico Elvedi"],
            ...
            ["SUI16", "Michel Aebischer"], ["SUI17", "Breel Embolo"], ["SUI18", "Rubén Vargas"],
    ...
    },
    {
        team: "Tunisia",
        stickers: [
            ["TUN1", "Team Logo"], ["TUN2", "Bechir Ben Said"], ["TUN3", "Aymen Dahmen"],
            ["TUN4", "Yan Valery"], ["TUN5", "Montassar Talbi"], ["TUN6", "Yassine Meriah"],
            ["TUN7", "Ali Abdi"], ["TUN8", "Dylan Bronn"], ["TUN9", "Ellyes Skhiri"],
            ["TUN10", "Aïssa Laïdouni"], ["TUN11", "Ferjani Sassi"], ["TUN12", "Mohamed Ali Ben Romdhane"],
            ["TUN13", "Team Photo"], ["TUN14", "Hannibal Mejbri"], ["TUN15", "Elias Achouri"],
            ["TUN16", "Elias Saad"], ["TUN17", "Hazem Mastouri"], ["TUN18", "Ismaël Gharbi"],
    ...
    },
    {
        team: "Türkiye",
        stickers: [
            ["TUR1", "Team Logo"], ["TUR2", "Uğurcan Çakır"], ["TUR3", "Mert Müldür"],
            ["TUR4", "Zeki Çelik"], ["TUR5", "Abdülkerim Bardakcı"], ["TUR6", "Çağlar Söyüncü"],
            ["TUR7", "Merih Demiral"], ["TUR8", "Ferdi Kadıoğlu"], ["TUR9", "Kaan Ayhan"],
            ["TUR10", "İsmail Yüksek"], ["TUR11", "Hakan Çalhanoğlu"], ["TUR12", "Orkun Kökçü"],
            ["TUR13", "Team Photo"], ["TUR14", "Arda Güler"], ["TUR15", "İrfan Can Kahveci"],
            ["TUR16", "Yunus Akgün"], ["TUR17", "Can Uzun"], ["TUR18", "Barış Alper Yılmaz"],
            ["TUR19", "Kerem Aktürkoğlu"], ["TUR20", "Kenan Yıldız"],
        ],
    },
    {
        team: "Uruguay",
        stickers: [
            ["URU1", "Team Logo"], ["URU2", "Sergio Rochet"], ["URU3", "Santiago Mele"],
            ["URU4", "Ronald Araújo"], ["URU5", "José María Giménez"], ["URU6", "Sebastian Cáceres"],
            ["URU7", "Mathías Olivera"], ["URU8", "Guillermo Varela"], ["URU9", "Nahitan Nández"],
            ...
            ["URU16", "Maxi Araújo"], ["URU17", "Darwin Núñez"], ["URU18", "Federico Viñas"],
    ...
    },
    {
        team: "USA",
        stickers: [
            ["USA1", "Team Logo"], ["USA2", "Matt Freese"], ["USA3", "Chris Richards"],
            ["USA4", "Tim Ream"], ["USA5", "Mark McKenzie"], ["USA6", "Alex Freeman"],
            ["USA7", "Antonee Robinson"], ["USA8", "Tyler Adams"], ["USA9", "Tanner Tessmann"],
            ["USA10", "Weston McKennie"], ["USA11", "Christian Roldan"], ["USA12", "Timothy Weah"],
    ...
    },
    {
        team: "Uzbekistan",
        stickers: [
            ["UZB1", "Team Logo"], ["UZB2", "Utkir Yusupov"], ["UZB3", "Farrukh Sayfiev"],
            ["UZB4", "Sherzod Nasrullaev"], ["UZB5", "Umar Eshmurodov"], ["UZB6", "Husniddin Aliqulov"],
            ["UZB7", "Rustam Ashurmatov"], ["UZB8", "Khojiakbar Allonov"], ["UZB9", "Abdukodir Khusanov"],
    ...
    {
        team: "Coca-Cola Insert Set",
        stickers: [
            ["CC1", "Lamine Yamal — Spain"],
            ["CC2", "Joshua Kimmich — Germany"],
            ["CC3", "Harry Kane — England"],
            ["CC4", "Santiago Giménez — Mexico"],
            ["CC5", "Antonee Robinson — USA"],
            ["CC6", "Jefferson Lerma — Colombia"],
            ["CC7", "Edson Álvarez — Mexico"],
            ["CC8", "Virgil van Dijk — Netherlands"],
            ["CC9", "Alphonso Davies — Canada"],
            ["CC10", "Weston McKennie — USA"],
            ["CC11", "Lautaro Martínez — Argentina"],
            ["CC12", "Gabriel Magalhães — Brazil"],
        ],
    },
];
