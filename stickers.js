...
const TEAM_META = {
    ...
    "Bosnia and Herzegovina": { flag: "🇧🇦", colors: ["#002395", "#fecb00"] },
    "Brazil": { flag: "🇧🇷", colors: ["#009c3b", "#ffdf00"] },
    "Canada": { flag: "🇨🇦", colors: ["#d52b1e", "#ffffff", "#d52b1e"] },
    "Cape Verde": { flag: "🇨🇻", colors: ["#003893", "#cf2027"] },
    ...
    "Iran": { flag: "🇮🇷", colors: ["#239f40", "#ffffff", "#da0000"] },
    "Iraq": { flag: "🇮🇶", colors: ["#ce1126", "#ffffff", "#000000"] },
    "Ivory Coast": { flag: "🇨🇮", colors: ["#ff8200", "#ffffff", "#009e60"] },
    ...
    "South Korea": { flag: "🇰🇷", colors: ["#cd2e3a", "#0047a0"] },
...
const STICKER_DATA = [
    ...
    },
    {
        ...
        stickers: [
            ...
            ["ALG7", "Aïssa Mandi"], ["ALG8", "Ismael Bennacer"], ["ALG9", "Houssem Aouar"],
    ...
    },
    {
        team: "Argentina",
        stickers: [
            ["ARG1", "Team Logo"], ["ARG2", "Emiliano Martinez"], ["ARG3", "Nahuel Molina"],
    ...
    },
    {
        ...
        stickers: [
            ["BIH1", "Team Logo"], ["BIH2", "Nikola Vasilj"], ["BIH3", "Amer Dedic"],
    ...
    },
    {
        ...
        stickers: [
            ...
            ["COL16", "Jorge Carrascal"], ["COL17", "Jhon Arias"], ["COL18", "Jhon Cordoba"],
    ...
    },
    {
        team: "Croatia",
        stickers: [
            ["CRO1", "Team Logo"], ["CRO2", "Dominik Livaković"], ["CRO3", "Duje Caleta-Car"],
    ...
    },
    {
        ...
        stickers: [
            ...
            ["ECU13", "Team Photo"], ["ECU14", "John Yeboah"], ["ECU15", "Leonardo Campana"],
    ...
    },
    {
        team: "Egypt",
        stickers: [
            ["EGY1", "Team Logo"], ["EGY2", "Mohamed El Shenawy"], ["EGY3", "Mohamed Hany"],
    ...
    },
    {
        team: "France",
        stickers: [
            ["FRA1", "Team Logo"], ["FRA2", "Mike Maignan"], ["FRA3", "Theo Hernandez"],
    ...
    },
    {
        ...
        stickers: [
            ...
            ["MAR7", "Roman Saiss"], ["MAR8", "Jawad El Yamiq"], ["MAR9", "Adam Masina"],
    ...
    },
    {
        team: "Norway",
        stickers: [
            ["NOR1", "Team Logo"], ["NOR2", "Orjan Nyland"], ["NOR3", "Julian Ryerson"],
    ...
    },
    {
        team: "Panama",
        stickers: [
            ["PAN1", "Team Logo"], ["PAN2", "Orlando Mosquera"], ["PAN3", "Luis Mejia"],
    ...
    },
    {
        team: "Paraguay",
        stickers: [
            ["PAR1", "Team Logo"], ["PAR2", "Roberto Fernandez"], ["PAR3", "Orlando Gill"],
    ...
    },
    {
        team: "Portugal",
        stickers: [
            ["POR1", "Team Logo"], ["POR2", "Diogo Costa"], ["POR3", "Jose Sa"],
    ...
    },
    {
        team: "Saudi Arabia",
        stickers: [
            ["KSA1", "Team Logo"], ["KSA2", "Nawaf Alaqidi"], ["KSA3", "Abdulrahman Al-Sanbi"],
    ...
    },
    {
        team: "Spain",
        stickers: [
            ["ESP1", "Team Logo"], ["ESP2", "Unai Simon"], ["ESP3", "Robin Le Normand"],
    ...
    },
    {
        team: "Türkiye",
        stickers: [
            ["TUR1", "Team Logo"], ["TUR2", "Ugurcan Cakir"], ["TUR3", "Mert Muldur"],
    ...
    },
    {
        team: "Uzbekistan",
        stickers: [
            ["UZB1", "Team Logo"], ["UZB2", "Utkir Yusupov"], ["UZB3", "Farrukh Savfiev"],
